...
dotnet ef dbcontext scaffold Name=ConnectionStrings:Database Microsoft.EntityFrameworkCore.SqlServer --output-dir Models --context-dir Context --context GamersCommunityDbContext --force --use-database-names --startup-project ../MainSite.Consumer --no-onconfiguring
