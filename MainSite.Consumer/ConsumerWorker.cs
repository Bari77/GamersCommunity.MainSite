...
namespace MainSite.Consumer
{
    ...
    /// <remarks>
    /// <para>
    /// This worker wraps a <see cref="MainSiteServiceConsumer"/> and executes its
    /// <see cref="MainSiteServiceConsumer.StartListeningAsync(CancellationToken)"/> method
    ...
    public class ConsumerWorker(IServiceScopeFactory scopeFactory, ILogger logger) : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken ct)
        {
            ...
            var consumer = scope.ServiceProvider.GetRequiredService<MainSiteServiceConsumer>();
