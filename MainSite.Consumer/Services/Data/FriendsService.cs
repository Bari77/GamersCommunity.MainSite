...
namespace MainSite.Consumer.Services.Data
{
    ...
    /// in <see cref="GenericTableService{TContext, TEntity}"/>, while associating them with the logical table name <c>"Friends"</c>.
    /// </para>
    /// </remarks>
    /// <param name="context">
    ...
    /// </param>
    public class FriendsService(GamersCommunityDbContext context) : GenericTableService<GamersCommunityDbContext, Friend>(context, "Friends")
    {
    }
}
