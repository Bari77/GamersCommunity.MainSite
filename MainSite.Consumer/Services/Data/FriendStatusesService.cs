...
namespace MainSite.Consumer.Services.Data
{
    ...
    /// in <see cref="GenericTableService{TContext, TEntity}"/>, while associating them with the logical table name <c>"FriendStatuses"</c>.
    /// </para>
    /// </remarks>
    /// <param name="context">
    ...
    /// </param>
    public class FriendStatusesService(GamersCommunityDbContext context) : GenericTableService<GamersCommunityDbContext, FriendStatus>(context, "FriendStatuses")
    {
    }
}
